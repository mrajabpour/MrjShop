...
public static partial class MVC
{
    ...
    public static MRJ.Web.Controllers.AccountController Account = new MRJ.Web.Controllers.T4MVC_AccountController();
    public static MRJ.Web.Controllers.HomeController Home = new MRJ.Web.Controllers.T4MVC_HomeController();
    public static MRJ.Web.Controllers.SearchController Search = new MRJ.Web.Controllers.T4MVC_SearchController();
    public static MRJ.Web.Controllers.SiteMapController SiteMap = new MRJ.Web.Controllers.T4MVC_SiteMapController();
    public static MRJ.Web.Controllers.TestController Test = new MRJ.Web.Controllers.T4MVC_TestController();
...
namespace T4MVC
{
    ...
    public class AdminPanelClass
    {
        ...
        public MRJ.Web.Areas.AdminPanel.Controllers.DashboardController Dashboard = new MRJ.Web.Areas.AdminPanel.Controllers.T4MVC_DashboardController();
    ...
    public class PageClass
    {
        ...
        public MRJ.Web.Areas.Page.Controllers.AdminController Admin = new MRJ.Web.Areas.Page.Controllers.T4MVC_AdminController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class PostClass
    {
        public readonly string Name = "Post";
        public MRJ.Web.Areas.Post.Controllers.AdminController Admin = new MRJ.Web.Areas.Post.Controllers.T4MVC_AdminController();
        public MRJ.Web.Areas.Post.Controllers.HomeController Home = new MRJ.Web.Areas.Post.Controllers.T4MVC_HomeController();
    ...
    public class PostCategoryClass
    {
        ...
        public MRJ.Web.Areas.PostCategory.Controllers.AdminController Admin = new MRJ.Web.Areas.PostCategory.Controllers.T4MVC_AdminController();
    ...
    public class ProductClass
    {
        ...
        public MRJ.Web.Areas.Product.Controllers.AdminController Admin = new MRJ.Web.Areas.Product.Controllers.T4MVC_AdminController();
        public MRJ.Web.Areas.Product.Controllers.HomeController Home = new MRJ.Web.Areas.Product.Controllers.T4MVC_HomeController();
        public MRJ.Web.Areas.Product.Controllers.SearchProductController SearchProduct = new MRJ.Web.Areas.Product.Controllers.T4MVC_SearchProductController();
        public MRJ.Web.Areas.Product.Controllers.UploadController Upload = new MRJ.Web.Areas.Product.Controllers.T4MVC_UploadController();
    ...
    public class ProductCategoryClass
    {
        ...
        public MRJ.Web.Areas.ProductCategory.Controllers.AdminController Admin = new MRJ.Web.Areas.ProductCategory.Controllers.T4MVC_AdminController();
    ...
    public class SiteSettingClass
    {
        ...
        public MRJ.Web.Areas.SiteSetting.Controllers.AdminController Admin = new MRJ.Web.Areas.SiteSetting.Controllers.T4MVC_AdminController();
    ...
    public class SlideShowClass
    {
        ...
        public MRJ.Web.Areas.SlideShow.Controllers.AdminController Admin = new MRJ.Web.Areas.SlideShow.Controllers.T4MVC_AdminController();
    ...
    public class UserClass
    {
        ...
        public MRJ.Web.Areas.User.Controllers.AdminController Admin = new MRJ.Web.Areas.User.Controllers.T4MVC_AdminController();
